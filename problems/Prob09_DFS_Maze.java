...
public class Prob09_DFS_Maze {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("=== Maze Problem using DFS ===");
    ...
    static void dfs() {
        ...
        stack.push(new Point(startR, startC, "Start: (" + startR + ", " + startC + ")\n"));
        ...
        while (!stack.isEmpty()) {
            ...
            for (int i = 0; i < 4; i++) {
                ...
                if (nr >= 0 && nr < rows && nc >= 0 && nc < cols && maze[nr][nc] == 0 && !visited[nr][nc]) {
                    visited[nr][nc] = true;
                    stack.push(new Point(nr, nc, curr.path + "Move " + dirNames[i] + " to (" + nr + ", " + nc + ")\n"));
                }
            }
        }
